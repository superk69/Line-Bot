...
function callAppsScript(auth) {
  var scriptId = 'https://script.google.com/a/macros/ubu.ac.th/s/AKfycbytMNdXS9fuQzNPXZMzqlpfelTxkBUNCfAKIJQWF_9gdhagLes/exec';
  ...
  script.scripts.run({
    ...
    if (resp.error) {
      ...
      var folderSet = resp.response.results;
